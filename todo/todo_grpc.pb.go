...
func (c *todoServiceClient) GetTodo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TodoContent, error) {
	out := new(TodoContent)
	err := c.cc.Invoke(ctx, "/user.TodoService/GetTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTodoServiceServer) GetTodo(context.Context, *emptypb.Empty) (*TodoContent, error) {
...
func _TodoService_GetTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.TodoService/GetTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).GetTodo(ctx, req.(*emptypb.Empty))
	}
